sap.ui.define([
    ...
    return BaseController.extend("upload.controller.Worklist", {
        ...
        onUpload: function (oEvent) {
            ...
            {
            var data = {};    
            var refresh = this.getView().getModel("uploadModel").getProperty("/",data);
            refresh = [];
            this.getView().getModel("uploadModel").setProperty("/",refresh);
            }
            this.getRouter().navTo("Upload",{ UploadId:oEvent.getId()});
        },
        ...
        _showObject : function (oItem) {
            this.getRouter().navTo("object", {
                objectId: oItem.getBindingContext().getPath().substring("/UXT".length)
            });
        },
